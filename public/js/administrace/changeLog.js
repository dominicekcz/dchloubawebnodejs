...
let loadLastChangeLog = () => {
    $.post("loadLastChangeLog", (res) => {
        $("section#lastChangeLog").html('<h1>Poslední vydaná <span>aktualizace</span></h1><h1>Aktualizace <span>'+res[0].versionName+'</span></h1><h2>'+res[0].descript+'</h2><div id="separatorLine"></div><p>'+res[0].changes+'</p>')
    }, "json")
}
